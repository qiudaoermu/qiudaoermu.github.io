...
美国斯坦福大学最近在一份报告中分析了过去 20 年间出现的几乎所有的处理器，发现处理器性能提高了约 1 万倍。该报告进一步指出，在 1 万倍的性能提升中，半导体工艺贡献了 100 多倍，计算机体系结构贡献了 80 多倍，可见计算机结构的重要性。
...
比如未来计算机模型，计算机存储材料，智能芯片，特定场景CPU研发，比如在人工智能芯片方面，谷歌开发了用于AI计算高性能硬件TPU，Intel推出了针对深度学习市场的众核CPU Knights Mill，英伟达推出了GPGPU，而且还有了DGX-1这样的产品；下一代计算机体系展望，包括近年来的出现的量子计算机，光子计算机，神经计算机（Neural computer）等。

该领域的四大国际顶级会议: **ISCA(偏芯片领域), HPCA, MICRO, ASPLOS**，几乎所有计算机体系结构领域的重大技术突破都是最早发表在这四大会议上。

ps: 对于体系结构领域的应届毕业生来说，市场上有大致上三种工作可以选，一种是去做金融，高频交易之类，薪水很高；另一种是去做机器学习，利用体系结构领域的知识和技能去做机器学习应用的调优，也是薪水很高；比较符合体系结构传统的工作，例如去传统的芯片设计公司做芯片，比如芯片领域，中国当前的状态，这个专业将迎来爆发阶段，在过去的四个季度，全球20个增速最快芯片公司，19个来自中国。

前一段时间看到老石谈芯的**石侃**(`伦敦帝国理工学院电子工程系博士、高级 FPGA 研发工程师`)宣布回国，现就任某芯片大厂，随着更多尖端人才的回流，相信中国的计算机技术会越来越强大。

##### 1.3 Computer languge
##### 1.4 高性能计算（High-performance computing）
...
##### 1.8 计算机安全
随着计算机的繁荣，计算机安全愈加收到重视，企业、政府、军队等机构都需要构建自己的防火墙。
##### 1.9 计算机工程
主要研究软件的统筹管理。
...
###### 2.1 Algorithms & complexity(算法和复杂度)
